...
@section('title', 'Add New Item - Saradha Lanka ERP')
    ...
    <div class="p-6">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Create a new inventory item or product</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="code" name="code"
                                ...
                                value="{{ old('code') }}" placeholder="e.g., ITM-001" required>
                            @error('code')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select id="category" name="category"
                                ...
                                <option value="finished_goods" {{ old('category') == 'finished_goods' ? 'selected' : '' }}>Finished Goods</option>
                                <option value="semi_finished" {{ old('category') == 'semi_finished' ? 'selected' : '' }}>Semi Finished</option>
                                <option value="consumables" {{ old('category') == 'consumables' ? 'selected' : '' }}>Consumables</option>
                                <option value="spare_parts" {{ old('category') == 'spare_parts' ? 'selected' : '' }}>Spare Parts</option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="specifications" name="specifications" rows="3"
                                ...
                                placeholder="Technical specifications, dimensions, etc.">{{ old('specifications') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" id="unit_of_measure" name="unit_of_measure"
                                ...
                                value="{{ old('unit_of_measure', 'pcs') }}" placeholder="e.g., pcs, kg, ltr" required>
                        ...
                        <div>
                            ...
                            <input type="number" id="maximum_stock_level" name="maximum_stock_level"
                                ...
                                value="{{ old('maximum_stock_level', '0') }}" min="0" required>
                        ...
                        <div class="md:col-span-2 lg:col-span-3">
                            ...
                            <input type="text" id="dimensions" name="dimensions"
                                ...
                                value="{{ old('dimensions') }}" placeholder="e.g., 10cm x 20cm x 5cm">
                            @error('dimensions')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
