...
@section('title', 'Edit Supplier - Saradha Lanka ERP')
    ...
    <div class="p-6">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Update {{ $supplier->name }} information</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="company_type" name="company_type"
                                ...
                                <option value="corporation" {{ old('company_type', $supplier->company_type) == 'corporation' ? 'selected' : '' }}>Corporation</option>
                                <option value="partnership" {{ old('company_type', $supplier->company_type) == 'partnership' ? 'selected' : '' }}>Partnership</option>
                                <option value="sole_proprietorship" {{ old('company_type', $supplier->company_type) == 'sole_proprietorship' ? 'selected' : '' }}>Sole Proprietorship</option>
                                <option value="llc" {{ old('company_type', $supplier->company_type) == 'llc' ? 'selected' : '' }}>LLC</option>
                                <option value="other" {{ old('company_type', $supplier->company_type) == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                            @error('company_type')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select id="category" name="category"
                                ...
                                <option value="material" {{ old('category', $supplier->category) == 'material' ? 'selected' : '' }}>Material</option>
                                <option value="service" {{ old('category', $supplier->category) == 'service' ? 'selected' : '' }}>Service</option>
                                <option value="both" {{ old('category', $supplier->category) == 'both' ? 'selected' : '' }}>Both</option>
                            </select>
                            @error('category')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select id="rating" name="rating"
                                ...
                                <option value="2" {{ old('rating', $supplier->rating) == '2' ? 'selected' : '' }}>2 Stars</option>
                                <option value="3" {{ old('rating', $supplier->rating) == '3' ? 'selected' : '' }}>3 Stars</option>
                                <option value="4" {{ old('rating', $supplier->rating) == '4' ? 'selected' : '' }}>4 Stars</option>
                                <option value="5" {{ old('rating', $supplier->rating) == '5' ? 'selected' : '' }}>5 Stars</option>
                            </select>
                            @error('rating')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="credit_period" name="credit_period"
                                ...
                                value="{{ old('credit_period', $supplier->credit_period) }}" min="0">
                            @error('credit_period')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="discount_percentage" name="discount_percentage" step="0.01"
                                ...
                                value="{{ old('discount_percentage', $supplier->discount_percentage) }}" min="0" max="100">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="payment_terms" name="payment_terms" rows="3"
                                ...
                                placeholder="Describe payment terms and conditions">{{ old('payment_terms', $supplier->payment_terms) }}</textarea>
                            @error('payment_terms')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="bank_routing_number" name="bank_routing_number"
                                ...
                                value="{{ old('bank_routing_number', $supplier->bank_routing_number) }}">
